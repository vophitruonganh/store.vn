        ...
        <div class="col-md-9">
          <div class="products-details">
            <div class="preview_image">
              ...
              <img id="zoom_01" class="img-responsive text-center" style="max-width: 200px" src="{{ url('images',$attachment->url) }}" data-zoom-image="{{ url('images',$attachment->url) }}" alt="{{ $product->name }}">
              @endforeach
              </div>
              <div class="thum-image">
                <ul id="gallery_01" class="prev-thum"><li><a href="" data-image="{{ url('images',$attachment->url) }}" data-zoom-image="{{ url('images',$attachment->url) }}"><img src="{{ url('images',$attachment->url) }}" alt="{{ $product->name }}"></a></li></ul>
            ...
            <div class="products-description">
              ...
              <form id="add-item-form" action="" method="post" class="variants clearfix">
                    ...
                    <input type="hidden" id="product_id" name="product_id" value="demo">
                    <div class="wided">
                      <div class="qty">
                        Số lượng &nbsp;&nbsp;:
                      ...
                      <div class="button_group">
                        <button class="button" onclick="order demo">
                          Đặt hàng
                        </button>
                      </div>
                    </div>
              ...
              <hr class="border">
              <img src="{{ asset('frontend/shop/images/share.png') }}" alt="" class="pull-right">
            </div>
          </div>
          <div class="clearfix">
          </div>
          <div class="tab-box">
            ...
            <div class="tab-content-wrap">
              <div class="tab-content col-lg-12" id="Descraption">
                @if ($product->description)
                <div class="col-lg-12">
                  <div class="row">
                    {{-- <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"><h3 class="text-center">THÔNG SỐ KỸ THUẬT</h3></div> --}}

                    <table class="table  table-responsive">
                      <thead>
                        <tr>
                          <th class="text-center"><h5>THUỘC TÍNH</h5></th>
                          <th class="text-center"><h5>THÔNG SỐ KỸ THUẬT</h5></th>
                        </tr>
                        <tbody>
                        @foreach ($product->description->jsonSerialize() as $key => $element)
                          <tr class="col">
                            <td class="text-center col-lg-6 bold">{{ strtoupper(str_ireplace('_',' ',$key)) }}</td>
                            <td class="text-center col-lg-6">{{ $element or 'Đang cập nhật' }}</td>
                          </tr>
                          @endforeach
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      ...
                      <div class="thumbnail"><img src="{{ asset('frontend/shop/images/products/small/products-01.png') }}" alt="Product Name"></div>
                  ...
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      <div class="thumbnail"><img src="{{ asset('frontend/shop/images/products/small/products-02.png') }}" alt="Product Name"></div>
                  ...
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      ...
                      <div class="thumbnail">
                        <img src="{{ asset('frontend/shop/images/products/small/products-03.png') }}" alt="Product Name">
                      </div>
                      <div class="productname">
                        Iphone 5s Gold 32 Gb 2013
                      </div>
        ...
        <div class="col-md-3">
          <div class="special-deal leftbar">
            ...
            <div class="special-item">
              <div class="product-image">
                <a href="#">
                  <img src="{{ asset('frontend/shop/images/products/thum/products-01.png') }}" alt="">
                </a>
              </div>
            ...
            <div class="special-item">
              <div class="product-image">
                <a href="#">
                  <img src="{{ asset('frontend/shop/images/products/thum/products-02.png') }}" alt="">
                </a>
              </div>
              <div class="product-info">
                <p>
            ...
            <div class="special-item">
              <div class="product-image">
                <a href="#">
                  <img src="{{ asset('frontend/shop/images/products/thum/products-03.png') }}" alt="">
                </a>
              </div>
              <div class="product-info">
                <p>
          ...
          <div class="fbl-box leftbar">
            ...
            <span class="likebutton">
              <a href="#"><img src="{{ asset('frontend/shop/images/fblike.png') }}" alt=""></a>
            </span>
            ...
            <div class="fbplug">
              <a href="#">
                <span>
                  <img src="{{ asset('frontend/shop/images/fbicon.png') }}" alt="">
                </span>
