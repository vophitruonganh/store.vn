        ...
        <!-- end sidebar -->
          ...
          <div class="products-list">
            ...
            <ul class="products-listItem">
              ...
              <li class="products">
                ...
                <div class="thumbnail">
                  ...
                  <a href="{{ url('collection',$item->id) }}"><img src="{{ url('images',$attachment->url) }}" alt="{{ $attachment->url }}"></a>
                  @endforeach
                ...
                <div class="product-list-description">
                  <div class="productname">
                   <a href="{{ url('collection',$item->id) }}">{{ strtoupper($item->name) }}</a>
                  </div>
                  ...
                  <div class="list_bottom">
                    <div class="price">
                      <span class="new_price">{{ number_format($item->price) }}<sup>đ</sup></span>
                    </div>
            ...
            <div class="toolbar">
              ...
              <div class="col-lg-12 text-right">{{ $items->getProducts()->links() }}</div>
            </div>
          </div>
        </div>
  </div>
