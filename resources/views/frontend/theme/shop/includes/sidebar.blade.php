<div class="col-md-3">
  <div class="category leftbar"><h3 class="title">Nhóm sản phẩm</h3>
    ...
    @foreach ($categories as $category)
      <li> <a href="{{ url('collection/category',$category->url) }}">{{ $category->name }}</a></li>
    @endforeach
  ...
  <div class="branch leftbar">
    ...
    @foreach ($trademarks as $trademark)
      <li> <a href="{{ url('collection/trademark',$trademark->url) }}">{{ $trademark->name }}</a></li>
    @endforeach
    </ul>
  </div>
  ...
  <div class="leftbanner"> <img src="{{asset('frontend/shop/images/banner-small-01.pn')}}g" alt=""> </div>
</div>
