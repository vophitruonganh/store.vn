            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="index.html"><img src="{{asset('frontend/shop/images/logo.png')}}" alt="FlatShop"></a></div>
                  </div>
                  <div class="col-md-10 col-sm-10">
					<!-- header top -->
					 @include('frontend.theme.shop.includes.header_top')
					 <!-- end header top-->
                     ...
                     <div class="header_bottom">
                        ...
                        <!-- menu -->
                        @include('frontend.theme.shop.includes.navigation')
						      <!-- end menu-->
                     </div>
                  </div>
               </div>
