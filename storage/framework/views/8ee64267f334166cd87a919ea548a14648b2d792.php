            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-10 col-sm-10">
					<!-- header top -->
					 <?php echo $__env->make('frontend.theme.shop.includes.header_top', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					 <!-- end header top-->
                     ...
                     <div class="header_bottom">
                        ...
                        <!-- menu -->
                        <?php echo $__env->make('frontend.theme.shop.includes.navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
						      <!-- end menu-->
                     </div>
                  </div>
               </div>
