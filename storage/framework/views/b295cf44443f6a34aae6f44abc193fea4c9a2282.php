              ...
              <li>
                <a href="#">
                  <div class="brand-logo">
                    <img src="<?php echo e(asset('frontend/shop/images/envato.png')); ?>" alt="">
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <div class="brand-logo">
                    <img src="<?php echo e(asset('frontend/shop/images/frontend.themeforest.png')); ?>" alt="">
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <div class="brand-logo">
                    <img src="<?php echo e(asset('frontend/shop/images/photodune.png')); ?>" alt="">
                  </div>
                </a>
              </li>
              <li>
                <a href="#">
                  <div class="brand-logo">
                    <img src="<?php echo e(asset('frontend/shop/images/activeden.png')); ?>" alt="">
                  </div>
                </a>
              </li>
              <li>
