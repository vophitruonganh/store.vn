...
<?php $__env->startSection('content'); ?>
   <?php echo $__env->make('theme.shop.includes.main_slide', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                             ...
                             <input type="hidden" name="quantity" value="1" />
                              ...
                              <div class="thumbnail">
                                 <a href="<?php echo e(url('collection',$product->id)); ?>">
                                    <img class="img-responsive" src="<?php echo e(url('images',$attachment->url)); ?>">
                                 </a>
                              </div>
                        ...
                        <div class="products">
                           <form action="" method="post" class="variants" id="" enctype="multipart/form-data">
                             ...
                             <input type="hidden" name="quantity" value="1" />
                              ...
                              <div class="thumbnail"><a href="#"><img src="<?php echo e(asset('/frontend/shop/images/products/small/products-0'.$i.'.png')); ?>"></a></div>
