        ...
        <!-- end sidebar -->
          ...
          <div class="products-list">
            ...
            <ul class="products-listItem">
              ...
              <?php $__currentLoopData = $listGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              <?php $__currentLoopData = $items->getProducts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              <li class="products">
                ...
                <div class="thumbnail">
                  ...
                  <?php $__currentLoopData = $item->attachment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  <a href="<?php echo e(url('collection',$item->id)); ?>"><img src="<?php echo e(url('images',$attachment->url)); ?>" alt="<?php echo e($attachment->url); ?>"></a>
                ...
                <div class="product-list-description">
                  <div class="productname">
                   <a href="<?php echo e(url('collection',$item->id)); ?>"><?php echo e(strtoupper($item->name)); ?></a>
                  </div>
                  ...
                  <div class="list_bottom">
                    <div class="price">
                      <span class="new_price"><?php echo e(number_format($item->price)); ?><sup>đ</sup></span>
                    </div>
            ...
            <div class="toolbar">
              ...
              <div class="col-lg-12 text-right"><?php echo e($items->getProducts()->links()); ?></div>
            </div>
          </div>
        </div>
  </div>
