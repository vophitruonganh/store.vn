<?php $__env->startSection('main-content'); ?>
	<?php if(Session::has('success')): ?>
		<p class="alert alert-success"><?php echo e(Session::get('success')); ?><span aria-hidden="true">&times;</span></p>
	<?php endif; ?>

	<?php if(Session::has('error')): ?>
		<p class="alert alert-danger"><?php echo e(Session::get('error')); ?><span aria-hidden="true">&times;</span></p>
	<?php endif; ?>
