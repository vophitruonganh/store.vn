        ...
        <div class="col-md-9">
          <div class="products-details">
            <div class="preview_image">
              ...
              <img id="zoom_01" class="img-responsive text-center" style="max-width: 200px" src="<?php echo e(url('images',$attachment->url)); ?>" data-zoom-image="<?php echo e(url('images',$attachment->url)); ?>" alt="<?php echo e($product->name); ?>">
                  ...
                  <div class="row">
                    ...
                    <table class="table  table-responsive">
                      <thead>
                        ...
                        <tbody>
                        <?php $__currentLoopData = $product->description->jsonSerialize(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $element): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                          <tr class="col">
                            <td class="text-center col-lg-6 bold"><?php echo e(strtoupper(str_ireplace('_',' ',$key))); ?></td>
                            <td class="text-center col-lg-6"><?php echo e(isset($element) ? $element : 'Đang cập nhật'); ?></td>
                          </tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
